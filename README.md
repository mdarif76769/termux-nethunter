...
<p align="center">
	<a href="hgjhg">
		<img
			src="https://img.shields.io/github/stars/mdarif76769/termux-nethunter?colorA=23272a&colorB=007bff&style=for-the-badge"
      alt="stars">
	</a>
	<a href="hhgjj">
		<img
			src="https://img.shields.io/github/issues/mdarif76769/termux-nethunter?colorA=23272a&colorB=ff4500&style=for-the-badge"
      alt="issues">
	</a>
	<a href="njjjhh">
		<img
			src="https://img.shields.io/github/contributors/mdarif76769/termux-nethunter?colorA=23272a&colorB=28a745&style=for-the-badge"
      alt="contributors">
	</a>
...
3. Download the install script
   ...
   ```bash
   curl -fsSLO https://raw.githubusercontent.com/mdarif76769/termux-nethunter/main/install-nethunter.sh
   ```
...
```bash
pkg update -y && pkg upgrade -y && pkg install -y curl && curl -fsSLO https://raw.githubusercontent.com/mdarif76769/termux-nethunter/main/install-nethunter.sh && bash install-nethunter.sh
```
...
If you encountered some hiccups during the installation or have some burning questions, you are probably not the first one. Feel free to document them in the [issues section](https://github.com/mdarif76769/termux-nethunter/issues "View the issues section.").
